namespace com.hack3rlife.dynamicprogramming
{
    public static class WordSearch
    {
        ...
        /// <summary>
        /// Given a 2D matrix of char­ac­ters. Check whether the word exist in the matrix or not. If it exists then print its path. All move­ments are allowed (right, left, up, down and 
        /// diagonally).
        /// 
        /// The 8 directions are, Horizontally Left, Horizontally Right, Vertically Up and 4 Diagonal directions.
        /// </summary>
        /// <param name="matrix">The board game</param>
        /// <param name="word">The string to be found</param>
        ...
        /// <summary>
        /// Helper function to find a string in a matrix
        /// </summary>
